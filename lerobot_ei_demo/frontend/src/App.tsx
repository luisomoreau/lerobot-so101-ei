  ...
  return <main>
    ...
    <div className="app-layout">
      <aside className="config-panel" aria-label="Configuration">
        ...
        <section className="config-section"><h2>Robot setup</h2><label>Robot<select><option>SO-101 leader/follower</option></select></label><button type="button" onClick={() => setRobotSetupOpen(true)}>Set up robot pair</button><div className="calibration-status"><span className={calibration.leader ? "ready" : "missing"}>Leader {calibration.leader ? "calibrated" : "needs calibration"}</span><span className={calibration.follower ? "ready" : "missing"}>Follower {calibration.follower ? "calibrated" : "needs calibration"}</span></div><div className="calibration-main-downloads"><a className={calibration.leader ? "" : "disabled-link"} href={calibration.leader ? "/api/calibration/download/leader" : undefined} download>Download leader calibration</a><a className={calibration.follower ? "" : "disabled-link"} href={calibration.follower ? "/api/calibration/download/follower" : undefined} download>Download follower calibration</a></div></section>
